...
public class Jeu : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for(int i=0;i<nb_alliee_total;i++) 
        {
            ...
            {
                unites_alliees.Add(new Unite(1000, 10, 5f, Team.EquipeBleue, Type_unitee.Distance, canva_pour_texte_pv, true,50f));
        ...
        for(int i=0;i<nb_ennemis_total;i++) 
        {
            ...
            {
                unites_ennemies.Add(new Unite(1000, 10, 5f, Team.EquipeRouge, Type_unitee.Distance, canva_pour_texte_pv, true,50f));
