...
public class Jeu : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for(int i=0;i<nb_alliee_total;i++) 
        {
            ...
            {
                unites_alliees.Add(new Unite(100, 2, 2f, Team.Equipe1, Type_unitee.Melee, canva_pour_texte_pv, true,10f));
                CreerUnite(unites_alliees[i].PositionX, unites_alliees[i].PositionY, unites_alliees[i].PositionZ,1,1);
            }
            else /////////////////Alliée Distant/////////////////////
            {
                unites_alliees.Add(new Unite(100, 2, 2f, Team.Equipe1, Type_unitee.Distance, canva_pour_texte_pv, true,10f));
        ...
        for(int i=0;i<nb_ennemis_total;i++) 
        {
            ...
            {
                unites_ennemies.Add(new Unite(100, 2, 2f,Team.Equipe2, Type_unitee.Melee, canva_pour_texte_pv, true,10f));
                CreerUnite(unites_ennemies[i].PositionX, unites_ennemies[i].PositionY, unites_ennemies[i].PositionZ,2,1);
            }
            else /////////////////Ennemis Distant////////////////////
            {
                unites_ennemies.Add(new Unite(100, 2, 2f, Team.Equipe2, Type_unitee.Distance, canva_pour_texte_pv, true,10f));
